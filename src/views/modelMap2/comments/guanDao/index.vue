<template>
   <div id="guandao" v-show="status">
     <div id="bar1">
       <span></span>
     </div>
     <div id="bar2" v-show="s2">
       <span></span>
     </div>
     <div id="bar3" v-show="s3">
       <span></span>
     </div>
     <div id="bar4">
       <p style="margin-left: 0%;">第一环节<br>排水</p>
       <p style="margin-left: 16%;">第二环节<br>取水</p>
       <p style="margin-left: 16%;">第三环节<br>预处理</p>
       <p style="margin-left: 16%;">第四环节<br>仪表供水</p>
     </div>
   </div>
</template>
...
<style scoped>
#guandao{
  background: url("../../../../../public/image/guan.png");
  position: absolute;
  width: 526px;
  height: 75px;
  bottom: 10%;
...
#guandao #bar1,#bar2,#bar3{
  width: 68px;
  height: 16px;
  background-color: #46bdb7;
  border-radius: 2px;
  background-image: linear-gradient(273deg, #3eb0b1, transparent);
}


#guandao #bar1:after,#bar2:after,#bar3:after{
  position: absolute;
  width: 68px;
  height: 16px;
  background: -webkit-gradient(linear, left top, right top, color-stop(0%,rgba(255,255,255,0)),
  color-stop(98%,rgba(255,255,255,0.6)), color-stop(100%,rgba(255,255,255,0)));
}

#bar1:before,#bar2:before,#bar3:before{
  background: -webkit-radial-gradient(center, ellipse cover, rgba(255,255,255,0.35) 0%,
  rgba(255,255,255,0.01) 50%,rgba(255,255,255,0) 51%,rgba(255,255,255,0) 100%);
}
...
#bar1 span,#bar2 span,#bar3 span{
  ...
  background: url("../../../../../public/image/color_g.png");
