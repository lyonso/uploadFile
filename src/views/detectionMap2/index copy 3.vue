...
// 一楼
let serverConfig1=serverHttp+'/iserver/services/3D-1fworkspace/rest/realspace/datas/';
// 二楼
let serverConfig2=serverHttp+'/iserver/services/3D-2Fworkspace-2/rest/realspace/datas/';
...
name: "index",
  ...
  data() {
    return {
      ...
      layerServer:[
        {
          url:serverConfig1+"F1XiBaoFenSuiJi@离子色谱仪系统/config",
          name:'f1'
        },
        {
          url:serverConfig1+"Algae1@离子色谱仪系统/config",
          name:'f1'
        },
        {
          url:serverConfig1+"显微镜2@离子色谱仪系统/config",
          name:'f1'
        },
        {
          url:serverConfig1+"显微镜1@离子色谱仪系统/config",
          name:'f1'
        },
        {
          url:serverConfig1+"电感耦合等离子体质谱仪1@离子色谱仪系统/config",
          name:'f1'
        },
        {
          url:serverConfig1+"显微镜3@离子色谱仪系统/config",
          name:'f1'
        },
        {
          url:serverConfig1+"S1F@离子色谱仪系统/config",
          name:'f1'
        },
        {
          url:serverConfig1+"F1HuanNengQi@离子色谱仪系统/config",
          name:'f1'
        },

        {
          url:serverConfig2+"ModelMergeResult_1@2F/config",
          name:'f14'
        },
        {
          url:serverConfig2+"ModelMergeResult_2@2F/config",
          name:'f14'
        },
        {
          url:serverConfig2+"ModelMergeResult@2F/config",
          name:'f14'
        },
        {
          url:serverConfig2+"离子色谱仪@2F/config",
          name:'f14'
        },
        {
          url:serverConfig2+"紫外可见分光光度计@2F/config",
          name:'f14'
        },
        {
          url:serverConfig2+"酸度计@2F/config",
          name:'f14'
        },
        {
          url:serverConfig2+"紫外可见分光光度计_1@2F/config",
          name:'f14'
        },
        {
          url:serverConfig2+"电导率仪@2F/config",
          name:'f14'
        },
        {
          url:serverConfig2+"紫外可见分光光度计_2@2F/config",
          name:'f14'
        },
        {
          url:serverConfig2+"电子滴定仪@2F/config",
          name:'f14'
        },
  ...
  methods:{
    showBuilding(){
      ...
      for(let i=0;i<this.layerServer.length;i++){
        if(this.layerServer[i].name !=="f14" && this.layerServer[i].name!=="f15"){
          viewer.scene.addS3MTilesLayerByScp(this.layerServer[i].url, { name: this.layerServer[i].name });
        }else{
          let promise = viewer.scene.addS3MTilesLayerByScp(this.layerServer[i].url, { name: this.layerServer[i].name });
          if(this.layerServer[i].name==="f14"){
