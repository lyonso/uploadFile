...
import threeModel from '@/views/threeModelFBX'
...
// 一楼
let serverConfig1=serverHttp+'/iserver/services/3D-1fworkspace/rest/realspace';
// 二楼
let serverConfig2=serverHttp+'/iserver/services/3D-2Fworkspace-2/rest/realspace';
// 三楼
// let serverConfig3=serverHttp+'/iserver/services/3D-3FSCENE/rest/realspace';
let serverConfig3=serverHttp+'/iserver/services/3D-3fworkspace/rest/realspace';
...
name: "index",
  ...
  mounted() {
    ...
    handler.setInputAction(function(res) {
      ...
      //   }
      // }
      let id = viewer.scene.pick(res.position);
      if(typeof(id.primitive._id)!=='undefined'){
        // console.log(id.primitive._id)
        let modelUrl =null,modelType=null,modelCode=null;
        // console.log(id.primitive._name)
        switch (id.primitive._name) {
          case '紫外可见分光光度计_2@2F':
            modelCode='A030009';
            modelUrl='./fbx/ziwaikejianfenguangguangduji.fbx';
            modelType =1;
            break;
          case '紫外可见分光光度计@2F':
            modelCode='A030014';
          ...
          case '液相色谱高分辩质谱仪@3F':
            modelCode='A010013';
            modelUrl='./fbx/yexiangsepugaofenbianzhipulianyong.fbx';
            modelType =1;
            break;
          case '离子色谱仪@2F':
            modelCode='A010016';
            modelUrl='./fbx/lizisepuyixitong.fbx';
            modelType =1;
            break;
          case '单四级气质@3F':
            modelCode='A010007';
            modelUrl='./fbx/dansijiganqizhilianyong.fbx';
            modelType =1;
            break;
          case '三重四级杆气质@3F':
            modelCode='A010019';
            modelUrl='./fbx/sancongsijiganqizhilianyong.fbx';
            modelType =1;
            break;
          case 'ModelMergeResult@2F':
            modelCode='A040009';
            modelUrl='./fbx/liudongfenxiyi.fbx';
            modelType =1;
            break;
          case 'ModelMergeResult_1@2F':
            modelCode='A040018';
            modelUrl='./fbx/liudongfenxiyi.fbx';
            modelType =1;
            break;
          case '电感耦合等离子体质谱仪1@离子色谱仪系统':
            modelCode='A060003';
            modelUrl='./fbx/dianganouhedenglizitizhipuyi.fbx';
            modelType =1;
            break;
          case 'Algae1@离子色谱仪系统':
            modelCode='';
            modelUrl='./gltf/yiqi5.glb';
            modelType =2;
            break;
          case 'F1HuanNengQi@离子色谱仪系统':
            modelCode='';
            modelUrl='./gltf/yiqi6.glb';
            modelType =2;
            break;
          case 'F1XiBaoFenSuiJi@离子色谱仪系统':
            modelCode='';
            modelUrl='./gltf/yiqi9.glb';
            modelType =2;
            break;
          case 'yiqi2@3F':
            modelCode='';
            modelUrl='./gltf/yiqi4.glb';
            modelType =2;
            break;
          case 'yiqi1@3F':
            modelCode='';
            modelUrl='./gltf/3f_1.glb';
            modelType =2;
            break;
          default:
            console.log("当前模型没有")
        ...
        if(modelUrl!==null){
          self.showModel=true
          self.$refs.threeModel.listenChangeModel(modelUrl,modelType,modelCode)
          modelUrl=null;
        }
      }
  ...
  methods:{
    showBuilding(){
      ...
      let layerServer3 = viewer.scene.open(serverConfig3)
      ...
      Cesium.when(layerServer3,function(layers){
        layers.forEach(layer=>{
          layer.style3D.bottomAltitude = 18
        })
        setViewPoint();
      })
      ...
      function setViewPoint() {
        viewer.scene.camera.setView({
          destination: {x: -2748035.02888716, y: 4695699.130760341, z: 3328696.0250166906},
          orientation: {
            heading: 1.2345464938623358,
            pitch: -0.6969732858526005,
            roll: 0.000002080824510919399
          }
        })
      }
      // this.addFloorBorder();
